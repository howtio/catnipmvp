...
GitHub 上传提交说明中**严禁**包含任何以下内容：

1. 不允许包含 `Co-Authored-By`、`co-authored-by` 等协作署名标签
2. 不允许包含 "Claude"、"claude"、"AI" 等非人类协作者标签
3. 不允许在提交消息中提到 "generated by"、"created by"、"assisted by" 等 AI 生成声明
4. 提交消息只应说明**人类开发者做了什么**，不说明是谁协助生成

违反本规则的上传视为严重违规，必须回滚修正后重新上传。
